# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-30 15:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Article',
            fields=[
                ('AID', models.BigIntegerField(editable=False, help_text='The ID of the article', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('RID', models.BigIntegerField(editable=False, help_text='The ID of the reservation', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Media',
            fields=[
                ('MID', models.BigIntegerField(editable=False, help_text='The ID of the image', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Post',
            fields=[
                ('PID', models.BigIntegerField(editable=False, help_text='The ID of the post', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='User',
            fields=[
                ('UID', models.BigIntegerField(editable=False, help_text='The ID of the user', primary_key=True, serialize=False, unique=True)),
