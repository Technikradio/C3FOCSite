...
urlpatterns = [
    ...
    url(r'^actions/delete-article', views.admin_delete_article_from_pending_reservation,
        name="delete_article_from_reservation"),
    ...
    url(r'^actions/update-group-articles', views.action_update_group_articles, name="action_update_group_articles_properties"),
    url(r'^actions/add-article-to-group', views.action_add_article_to_group, name="action_add_new_article_to_group"),
    url(r'^actions/alter-article-group', views.action_alter_group_metadata, name="action_alter_article_group"),
    url(r'^actions/release-group', views.action_release_group, name="action_release_group"),
    url(r'^articles/editgroup', views.admin_edit_group, name="article_edit_group"),
