...
def render_header_edit_panel(request: HttpRequest):
    ...
    f.action_url(TextArea(name="property", label_text="Edit the content of the nav bar:", text=s.property,
        placeholder="Please define the content of the header using JSON"))
