...
def render_settings_page(request: HttpRequest):
    ...
    <a href="/admin/export?method=datadump" class="button">Export Database</a>
    ...
    '''.replace('%S%', m.property).replace('%U%', render_user_link(m.changedByUser))
    ...
    the following content:<p><code>%S%</code></p><br />It was last modified by: %U%
    <br /><a href="/admin/settings/edit-footer"><img src="/staticfiles/frontpage/edit.png"
    alt="edit" class="button-img"/></a>
